...
public class TEA {
    ...
    private static String quote = "963de044a6a164bc30e88a8dc9805be1b344553b(";

    public static void main(String[] args) {
		/* Create a cipher using the first 16 bytes of the passphrase */
        TEA tea = new TEA("stff1vtnfuur275d0ff676c0d65114acdefbd2ad87a3".getBytes());
